      ...
      <div className='px-2 flex justify-between items-center w-full h-full'>
        <div className='flex items-center'>
          ...
          <ul className='hidden md:flex'>
            <li className="cursor-pointer"><ScrollLink to="home" smooth={true} duration={500}>Objetivo</ScrollLink></li>
            <li className='cursor-pointer'><ScrollLink to="about" smooth={true} offset={-200} duration={500}>¿Quiénes somos?</ScrollLink></li>
            <li className='cursor-pointer'><ScrollLink to="support" smooth={true} offset={-50} duration={500}>Productos</ScrollLink></li>
            <li className='cursor-pointer'><ScrollLink to="platforms" smooth={true} offset={-100} duration={500}>Servicios</ScrollLink></li>
          </ul>
        </div>
